...
public class HistoricalRecordEntityJsonMapper {
  ...
  public HistoricalRecordEntity transformHistoricalRecordEntity(String historicalRecordJsonResponse) throws JsonSyntaxException {
    try {
      Type historicalRecordEntityType = new TypeToken<HistoricalRecordEntity>() {}.getType();
   ...
   * @throws com.google.gson.JsonSyntaxException if the json string is not a valid json structure.
   */
  public List<HistoricalRecordEntity> transformUserEntityCollection(String historicalRecordListJsonResponse)
