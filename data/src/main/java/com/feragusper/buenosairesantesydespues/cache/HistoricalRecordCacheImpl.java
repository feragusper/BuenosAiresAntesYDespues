...
public class HistoricalRecordCacheImpl implements HistoricalRecordCache {
  ...
  @Override public synchronized Observable<HistoricalRecordEntity> get(final int userId) {
    return Observable.create(new Observable.OnSubscribe<HistoricalRecordEntity>() {
      @Override public void call(Subscriber<? super HistoricalRecordEntity> subscriber) {
        File historicalRecordEntityFile = HistoricalRecordCacheImpl.this.buildFile(userId);
  ...
  @Override public synchronized void put(HistoricalRecordEntity historicalRecordEntity) {
    if (historicalRecordEntity != null) {
  ...
  @Override public boolean isCached(int historicalRecordId) {
